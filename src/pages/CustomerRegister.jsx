          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Box sx={{ display: "flex", gap: "20px", marginBottom: "20px" }}>
                ...
                <PhoneInput
                  country={"in"}
                  value={formData.mobileNo} // Ensure that formData.mobileNo is always a string
                  onChange={
                    (value) => setFormData({ ...formData, mobileNo: value }) // Make sure you're updating the state with the correct value
                  }
                  inputStyle={{
                    width: "100%",
                    height: "56px",
